...
describe Rack::IdempotentPost do
  ...
  it "does not cache bulk_jobs request" do
    post "/v1/organizations/1/bulk_jobs.json", { sample_data: 'sample_value' }
    first_repsonse = last_response.body
    post "/v1/organizations/1/bulk_jobs.json", { sample_data: 'sample_value' }
    last_response.body.should_not eq first_repsonse
    @inner_app_called.should eq 2
  ...
  it "does not cache updates request" do
    post "/v1/organizations/1/updates.json", { farm: "2013-05-28T18:50:12.478581Z" }
    first_repsonse = last_response.body
    post "/v1/organizations/1/updates.json", { farm: "2013-05-28T18:50:12.478581Z" }
    last_response.body.should_not eq first_repsonse
    @inner_app_called.should eq 2
